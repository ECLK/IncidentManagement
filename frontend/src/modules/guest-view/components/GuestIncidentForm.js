...
const VerticalLinearStepper = props => {
  ...
  const stepDefinitions = {
      ...
      handler: () => {
        ...
        if (!incidentId && incidentDateTime.date && incidentDateTime.time) {
          ...
          if (
            ...
            incidentDateTime.time
          ) {
            dispatch(
              updateGuestIncident(incidentId, { election: incidentElection })
            );
          }
        }
      }
    ...
    3: {
      ...
      handler: () => {
        if (
          incidentContact.name ||
          incidentContact.phone ||
          incidentContact.email
        ) {
  ...
  return (
    <div className={classes.root}>
      <Button variant="outlined" component={GoBackLink}>
        {" "}
        Back{" "}
      </Button>
      <h3>
